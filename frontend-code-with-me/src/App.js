        ...
        <div className="mt-6">
          {studentsService.students.map(student => (
            <div className="mb-2">
              ...
              {/* Displays student graduates info if graduates array is not empty */}
              {student.graduates && student.graduates.length > 0 && (
                <div className="ml-4">
                  {student.graduates.map((graduate, index) => (
                    <div key={index}>
                      <div>
                      ...
                      <div>
                        <span className="font-bold">Rog No: </span>
                        {graduate.rogNo}
                      </div>
                    </div>
                  ))}
